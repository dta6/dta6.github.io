    ...
    class e {
        constructor(e) {
            ...
            this.gp.socials.on("share", (e => {
                this.trigger("CallSocialsShare", e),
                window.focus()
            }
            )),
            this.gp.socials.on("post", (e => {
                this.trigger("CallSocialsPost", e),
                window.focus()
            }
            )),
            this.gp.socials.on("invite", (e => {
                this.trigger("CallSocialsInvite", e),
                window.focus()
            }
            )),
            this.gp.socials.on("joinCommunity", (e => {
                this.trigger("CallSocialsJoinCommunity", e),
                window.focus()
            }
            )),
            ...
            this.gp.documents.on("fetch", (e => this.trigger("CallOnDocumentsFetchSuccess", e.content))),
            this.gp.documents.on("error:fetch", ( () => this.trigger("CallOnDocumentsFetchError"))),
            this.gp.channels.on("createChannel", (e => {
                this.trigger("CallOnCreateChannel", JSON.stringify(t(e)))
            }
            )),
            this.gp.channels.on("error:createChannel", (e => this.trigger("CallOnCreateChannelError"))),
            this.gp.channels.on("updateChannel", (e => {
                this.trigger("CallOnUpdateChannel", JSON.stringify(t(e)))
            }
            )),
            this.gp.channels.on("error:updateChannel", (e => this.trigger("CallOnUpdateChannelError"))),
            this.gp.channels.on("deleteChannel", ( () => this.trigger("CallOnDeleteChannelSuccess"))),
            this.gp.channels.on("event:deleteChannel", (e => {
                this.trigger("CallOnDeleteChannelEvent", e.id)
            }
            )),
            this.gp.channels.on("error:deleteChannel", (e => this.trigger("CallOnDeleteChannelError"))),
            this.gp.channels.on("fetchChannel", (e => {
                this.trigger("CallOnFetchChannel", JSON.stringify(t(e)))
            }
            )),
            this.gp.channels.on("error:fetchChannel", (e => this.trigger("CallOnFetchChannelError"))),
            this.gp.channels.on("fetchChannels", (e => {
                this.trigger("CallOnFetchChannelsCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchChannels", JSON.stringify(e.items.map(t)))
            }
            )),
            this.gp.channels.on("error:fetchChannels", (e => this.trigger("CallOnFetchChannelsError"))),
            this.gp.channels.on("fetchMoreChannels", (e => {
                this.trigger("CallOnFetchMoreChannelsCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMoreChannels", JSON.stringify(e.items.map(t)))
            }
            )),
            this.gp.channels.on("error:fetchMoreChannels", (e => this.trigger("CallOnFetchMoreChannelsError"))),
            e.channels.on("openChat", ( () => this.trigger("CallOnOpenChat"))),
            e.channels.on("closeChat", ( () => this.trigger("CallOnCloseChat"))),
            e.channels.on("error:openChat", (e => this.trigger("CallOnOpenChatError"))),
            ...
            this.gp.channels.on("error:join", (e => this.trigger("CallOnJoinError"))),
            ...
            this.gp.channels.on("error:cancelJoin", (e => this.trigger("CallOnCancelJoinError"))),
            ...
            this.gp.channels.on("error:leave", (e => this.trigger("CallOnLeaveError"))),
            this.gp.channels.on("kick", ( () => this.trigger("CallOnKick"))),
            this.gp.channels.on("error:kick", (e => this.trigger("CallOnKickError"))),
            this.gp.channels.on("fetchMembers", (e => {
                this.trigger("CallOnFetchMembersCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMembers", JSON.stringify(e.items))
            }
            )),
            this.gp.channels.on("error:fetchMembers", (e => this.trigger("CallOnFetchMembersError"))),
            this.gp.channels.on("fetchMoreMembers", (e => {
                this.trigger("CallOnFetchMoreMembersCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMoreMembers", JSON.stringify(e.items))
            }
            )),
            this.gp.channels.on("error:fetchMoreMembers", (e => this.trigger("CallOnFetchMoreMembersError"))),
            ...
            this.gp.channels.on("error:mute", (e => this.trigger("CallOnMuteError"))),
            ...
            this.gp.channels.on("error:unmute", (e => this.trigger("CallOnUnmuteError"))),
            this.gp.channels.on("sendInvite", ( () => this.trigger("CallOnSendInvite"))),
            this.gp.channels.on("error:sendInvite", (e => this.trigger("CallOnSendInviteError"))),
            ...
            this.gp.channels.on("error:acceptInvite", (e => this.trigger("CallOnAcceptInviteError"))),
            ...
            this.gp.channels.on("error:rejectInvite", (e => this.trigger("CallOnRejectInviteError"))),
            this.gp.channels.on("fetchInvites", (e => {
                this.trigger("CallOnFetchInvitesCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchInvites", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchInvites", (e => this.trigger("CallOnFetchInvitesError"))),
            this.gp.channels.on("fetchMoreInvites", (e => {
                this.trigger("CallOnFetchMoreInvitesCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMoreInvites", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchMoreInvites", (e => this.trigger("CallOnFetchMoreInvitesError"))),
            this.gp.channels.on("fetchChannelInvites", (e => {
            ...
            this.gp.channels.on("error:fetchChannelInvites", (e => this.trigger("CallOnFetchChannelInvitesError"))),
            this.gp.channels.on("fetchMoreChannelInvites", (e => {
            ...
            this.gp.channels.on("error:fetchMoreChannelInvites", (e => this.trigger("CallOnFetchMoreChannelInvitesError"))),
            this.gp.channels.on("fetchSentInvites", (e => {
                this.trigger("CallOnFetchSentInvitesCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchSentInvites", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchSentInvites", (e => this.trigger("CallOnFetchSentInvitesError"))),
            this.gp.channels.on("fetchMoreSentInvites", (e => {
                this.trigger("CallOnFetchMoreSentInvitesCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMoreSentInvites", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchMoreSentInvites", (e => this.trigger("CallOnFetchMoreSentInvitesError"))),
            this.gp.channels.on("acceptJoinRequest", ( () => this.trigger("CallOnAcceptJoinRequest"))),
            this.gp.channels.on("error:acceptJoinRequest", (e => this.trigger("CallOnAcceptJoinRequestError"))),
            ...
            this.gp.channels.on("error:rejectJoinRequest", (e => this.trigger("CallOnRejectJoinRequestError"))),
            this.gp.channels.on("fetchJoinRequests", (e => {
                this.trigger("CallOnFetchJoinRequestsCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchJoinRequests", JSON.stringify(e.items))
            }
            )),
            this.gp.channels.on("error:fetchJoinRequests", (e => this.trigger("CallOnFetchJoinRequestsError"))),
            this.gp.channels.on("fetchMoreJoinRequests", (e => {
            ...
            this.gp.channels.on("error:fetchMoreJoinRequests", (e => this.trigger("CallOnFetchMoreJoinRequestsError"))),
            this.gp.channels.on("fetchSentJoinRequests", (e => {
                this.trigger("CallOnFetchSentJoinRequestsCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchSentJoinRequests", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchSentJoinRequests", (e => this.trigger("CallOnFetchSentJoinRequestsError"))),
            this.gp.channels.on("fetchMoreSentJoinRequests", (e => {
                this.trigger("CallOnFetchMoreSentJoinRequestsCanLoadMore", e.canLoadMore),
                this.trigger("CallOnFetchMoreSentJoinRequests", JSON.stringify(e.items.map(s)))
            }
            )),
            this.gp.channels.on("error:fetchMoreSentJoinRequests", (e => this.trigger("CallOnFetchMoreSentJoinRequestsError"))),
            this.gp.channels.on("sendMessage", (e => {
                this.trigger("CallOnSendMessage", JSON.stringify(e))
            }
            )),
            this.gp.channels.on("error:sendMessage", (e => this.trigger("CallOnSendMessageError"))),
            ...
            this.gp.channels.on("error:editMessage", (e => this.trigger("CallOnEditMessageError"))),
        ...
        LeaderboardFetch(e, t, s, r, n, i, a) {
            return this.gp.leaderboard.fetch({
                ...
                this.trigger("CallLeaderboardFetchTag", e),
                this.trigger("CallLeaderboardFetch", JSON.stringify(t.players)),
                this.trigger("CallLeaderboardFetchTop", JSON.stringify(t.topPlayers)),
                this.trigger("CallLeaderboardFetchAbove", JSON.stringify(t.abovePlayers)),
                this.trigger("CallLeaderboardFetchBelow", JSON.stringify(t.belowPlayers)),
                this.trigger("CallLeaderboardFetchOnlyPlayer", JSON.stringify(t.player))
            }
            )).catch((e => {
                console.warn(e),
        ...
        LeaderboardFetchPlayerRating(e, t, s) {
            return this.gp.leaderboard.fetchPlayerRating({
                ...
                this.trigger("CallLeaderboardFetchPlayerTag", e),
                this.trigger("CallLeaderboardFetchPlayerRating", t.player.position)
            }
            )).catch((e => {
                console.warn(e),
        ...
        LeaderboardScopedFetch(e, t, s, r, n, i, a) {
            ...
            return this.gp.leaderboard.fetchScoped({
                ...
                this.trigger("CallLeaderboardScopedFetchTag", e),
                this.trigger("CallLeaderboardScopedFetchVariant", t),
                this.trigger("CallLeaderboardScopedFetch", JSON.stringify(s.players)),
                this.trigger("CallLeaderboardScopedFetchTop", JSON.stringify(s.topPlayers)),
                this.trigger("CallLeaderboardScopedFetchAbove", JSON.stringify(s.abovePlayers)),
                this.trigger("CallLeaderboardScopedFetchBelow", JSON.stringify(s.belowPlayers)),
                this.trigger("CallLeaderboardScopedFetchOnlyPlayer", JSON.stringify(s.player))
            }
            )).catch((e => {
                console.warn(e),
        ...
        LeaderboardScopedFetchPlayerRating(e, t, s) {
            ...
            return this.gp.leaderboard.fetchPlayerRatingScoped({
                ...
                this.trigger("CallLeaderboardScopedFetchPlayerTag", e),
                this.trigger("CallLeaderboardScopedFetchPlayerVariant", t),
                this.trigger("CallLeaderboardScopedFetchPlayerRating", s.player.position)
            }
            )).catch((e => {
                console.warn(e),
                this.trigger("CallLeaderboardFetchPlayerError")
        ...
        PaymentsFetchProducts() {
            return this.gp.payments.fetchProducts().then((e => {
                this.trigger("CallPaymentsFetchProducts", JSON.stringify(e.products)),
                this.trigger("CallPaymentsFetchPlayerPurcahses", JSON.stringify(e.playerPurchases))
            }
            )).catch((e => {
                console.warn(e),
        ...
        PaymentsPurchase(e) {
            ...
            return this.gp.payments.purchase(s).then((t => {
                if (t.success)
                    return this.trigger("CallPaymentsPurchase", e),
                    void window.focus();
        ...
        PaymentsConsume(e) {
            ...
            return this.gp.payments.consume(s).then((t => {
                if (t.success)
                    return this.trigger("CallPaymentsConsume", e),
                    void window.focus();
        ...
        GamesCollectionsFetch(e) {
            ...
            return this.gp.gamesCollections.fetch(s).then((t => {
                this.trigger("CallGamesCollectionsFetchTag", e),
                this.trigger("CallGamesCollectionsFetch", JSON.stringify(t))
            }
            )).catch((e => {
                console.warn(e),
        ...
        PlayersFetch(e) {
            var t = JSON.parse(e);
            let s = [];
            s = parseInt(t, 10) > 0 ? [parseInt(t, 10)] : (t.idsList || t.idsArray).map(Number).filter(Boolean),
            this.gp.players.fetch({
                ids: s
            }).then((e => {
        ...
        FilesFetch(e) {
            ...
            this.gp.files.fetch(t).then((e => {
                this.trigger("CallFilesFetchCanLoadMore", e.canLoadMore),
                this.trigger("CallFilesFetchSuccess", JSON.stringify(e.items))
            }
            )).catch((e => {
        ...
        FilesFetchMore(e) {
            ...
            this.gp.files.fetchMore(t).then((e => {
                this.trigger("CallFilesFetchMoreCanLoadMore", e.canLoadMore),
                this.trigger("CallFilesFetchMoreSuccess", JSON.stringify(e.items))
            }
            )).catch((e => {
